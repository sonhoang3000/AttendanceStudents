...
cred = credentials.Certificate("C:/Users/mapqu/Downloads/AttendanceStudents-main/AttendanceStudents-main/serviceAccountKey.json")
    ...
    flattened_data = [
        {
            'id': info[0]['id'],
            'Tên': info[0]['name'],
            'Chuyên Ngành': info[0]['major'],
            'Tổng số lần điểm danh': info[0]['total_attendance'],
            'Thời gian điểm danh lần cuối ': info[0]['last_attendance_time'],
            'Năm': info[0]['year'],
